...
if __name__ == "__main__":
    report_folder = r"D:\llm_exam\next_steps\JAVA\Complete\evaluation_reports"  # Replace with the actual folder containing markdown reports
    output_json = "java_students_scores.json"  # Replace with desired JSON file name

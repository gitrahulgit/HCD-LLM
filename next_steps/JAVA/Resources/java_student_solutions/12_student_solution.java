    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (Book book : library.displayAvailableBooks()) {
                System.out.println("Book ID: " + book.getId() + ", Title: " + book.getName() + ", Status: " + (book.isAvailable() ? "Available" : "Unavailable"));
            }
            Borrower borrower = library.viewBorrowerHistory("B001");
            System.out.println("Borrower " + borrower.getName() + " has borrowed the following books:");
            for (String bookId : borrower.getBorrowedBooks()) {

...
if __name__ == "__main__":
    report_folder = r"D:\llm_exam\next_steps\LANGGRAPH\Partial\evaluation_reports"  # Replace with the actual folder path
    output_json = "lg_students_scores_partial.json"  # Desired output JSON file name
